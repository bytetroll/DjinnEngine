...
class HashMap {
public:
    static const Djinn::UInt32 DEFAULT_SIZE = 255;
...
public:
    ...
    ~HashMap() {
        ...
        Djinn::Core::Djinn_Memory_AlignedFree( Buffer );
...
private:
    ...
    void AllocateBuffers() {
        ...
        Buffer = reinterpret_cast< HashMapNode< KeyType, ValueType >* >( Djinn::Core::Djinn_Memory_AlignedMalloc( MallocSize, MallocAlignment ) );
    ...
    void Grow() {
        ...
        Djinn::Core::Djinn_Memory_AlignedFree( OldNodes );
