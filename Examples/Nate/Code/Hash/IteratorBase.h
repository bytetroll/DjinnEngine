...
struct IteratorBase {
public:
    using Category = typedef CategoryType;
    using Value = typedef ValueType;
    using PointerDifference = typedef PointerDifferenceType;

    using Pointer = typedef PointerType;
    using Reference = typedef ReferenceType;
};