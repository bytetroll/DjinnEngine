...
DJINN_C_EXPORT_EDITOR_HIERARCHY COM::Result DJINN_PLUGINAPI_INSTALL(Host::IRegistry *registry, Host::LoadFlagSet flags, Host::IPlugin* plugin) {
    if (flags & Host::LoadFlag::ePipeline) {
        ...
        // Add package
        worldHost->GetFeature(kEditorFeature)->AddPackage<HierarchyWorldPackage>();
    }
    return COM::kOK;
}

DJINN_C_EXPORT_EDITOR_HIERARCHY COM::Result DJINN_PLUGINAPI_DESTROY(Host::IRegistry *registry) {
    return COM::kOK;
}
