...
namespace Djinn::UI {
class DJINN_EXPORT_PLUGINS_UI_UIML UIMLWorldPackage : public Game::IWorldPackage {
    public:
        DJINN_COM_CLASS();
        ...
        /// \param registry
        /// \param outer
        UIMLWorldPackage(Host::IRegistry *registry, COM::IUnknown *outer, COM::IInstanceHost* host);
