...
DJINN_C_EXPORT_PLUGINS_UI_CORE COM::Result DJINN_PLUGINAPI_INSTALL(Host::IRegistry *registry, Host::LoadFlagSet flags, Host::IPlugin* plugin) {
    if (flags & Host::LoadFlag::ePipeline) {
        ...
        // Add package
        worldHost->GetFeature(Game::kDefaultFeature)->AddPackage<UI::UIWorldPackage>();
    }
    return COM::kOK;
}

DJINN_C_EXPORT_PLUGINS_UI_CORE COM::Result DJINN_PLUGINAPI_DESTROY(Host::IRegistry *registry) {
    return COM::kOK;
}