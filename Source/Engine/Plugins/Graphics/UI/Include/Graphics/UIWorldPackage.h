...
namespace Djinn::Graphics {
    class DJINN_EXPORT_PLUGINS_GRAPHICS_UI UIWorldPackage : public Game::IWorldPackage {
    public:
        DJINN_COM_CLASS();
        ...
        /// \param registry
        /// \param outer
        UIWorldPackage(Host::IRegistry *registry, COM::IUnknown *outer, COM::IInstanceHost* host);
