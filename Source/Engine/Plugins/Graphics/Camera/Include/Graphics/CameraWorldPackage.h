...
namespace Djinn::Graphics {
    class DJINN_EXPORT_PLUGINS_GRAPHICS_CAMERA CameraWorldPackage : public Game::IWorldPackage {
    public:
        DJINN_COM_CLASS();
        ...
        /// \param registry
        /// \param outer
        CameraWorldPackage(Host::IRegistry *registry, COM::IUnknown *outer, COM::IInstanceHost* host);
