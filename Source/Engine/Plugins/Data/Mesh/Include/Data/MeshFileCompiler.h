...
namespace Djinn::Data {
    ...
    class DJINN_EXPORT_PLUGINS_DATA_MESH MeshFileCompiler : public IFileAssetCompiler {
    public:
        DJINN_COM_CLASS();
        ...
        /// \param registry
        /// \param outer
        MeshFileCompiler(Host::IRegistry *registry, COM::IUnknown *outer, COM::IInstanceHost* host);
