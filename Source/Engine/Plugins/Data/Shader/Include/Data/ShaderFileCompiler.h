...
namespace Djinn::Data {
    ...
    class DJINN_EXPORT_PLUGINS_DATA_SHADER ShaderFileCompiler : public IFileAssetCompiler {
    public:
        DJINN_COM_CLASS();
        ...
        /// \param registry
        /// \param outer
        ShaderFileCompiler(Host::IRegistry *registry, COM::IUnknown *outer, COM::IInstanceHost* host);
